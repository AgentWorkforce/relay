...
```json
{
  ...
  "messages": [
    { "id": "msg-parent-rollout", "channel": "ops", "from": "Ada", "text": "rollout checklist" }
  ]
}
```
...
```json
[
  { "op": "reply_to_thread", "as": "Ben", "parent": "msg-parent-rollout", "text": "database backup complete", "id": "msg-reply-backup" },
...
```json
{
  ...
  "channels": [
    { "name": "planning", "members": ["Ada", "Ben", "Cy"] }
  ],
  "messages": [
    { "id": "msg-parent-plan", "channel": "planning", "from": "Ada", "text": "plan review" }
  ]
}
```
...
```json
[
  { "op": "reply_to_thread", "as": "Ben", "parent": "msg-parent-plan", "text": "risks logged", "id": "msg-reply-risks" },
  { "op": "reply_to_thread", "as": "Cy", "parent": "msg-parent-plan", "text": "owners assigned", "id": "msg-reply-owners" },
...
```json
{
  ...
  "channels": [
    { "name": "support", "members": ["Ada", "Ben"] }
  ],
  "messages": [
    { "id": "msg-parent-incident", "channel": "support", "from": "Ada", "text": "incident root cause" },
    { "id": "msg-seeded-reply", "channel": "support", "from": "Ben", "text": "cache invalidation confirmed", "threadParent": "msg-parent-incident" }
  ]
}
```
...
```json
{
  ...
  "messages": [
    { "id": "msg-parent-check", "channel": "ops", "from": "Ada", "text": "status check" }
  ]
}
```
...
```json
[
  { "op": "reply_to_thread", "as": "Ben", "parent": "msg-parent-check", "text": "thread-only acknowledgement", "id": "msg-reply-thread-only" },

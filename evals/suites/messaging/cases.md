...
```json
[
  { "op": "post_message", "as": "Ada", "channel": "ops", "text": "deploy window opens at 14:00", "id": "msg-channel-deploy" },
...
```json
[
  { "op": "send_group_dm", "as": "Ada", "participants": ["Ben", "Cy"], "name": "handoff-room", "text": "triage notes for Ben and Cy", "id": "msg-group-triage" },
  { "op": "check_inbox", "as": "Ben" },
...
```json
[
  { "op": "post_message", "as": "Ada", "channel": "ops", "text": "same deployment update", "id": "msg-idempotent-deploy", "idempotencyKey": "deploy-42" },
  { "op": "post_message", "as": "Ada", "channel": "ops", "text": "same deployment update", "id": "msg-idempotent-deploy-retry", "idempotencyKey": "deploy-42" },
  { "op": "list_messages", "channel": "ops", "limit": 10 }
]
```

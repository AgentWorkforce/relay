...
```json
{
  ...
  "messages": [
    { "id": "msg-react-target", "channel": "ops", "from": "Ada", "text": "ready for review" }
  ]
}
```
...
```json
{
  ...
  "messages": [
    { "id": "msg-react-idem", "channel": "ops", "from": "Ada", "text": "ship candidate" }
  ]
}
```
...
```json
{
  ...
  "messages": [
    { "id": "msg-react-multi", "channel": "planning", "from": "Ada", "text": "proposal ready" }
  ]
}
```
...
```json
{
  ...
  "messages": [
    { "id": "msg-react-absent", "channel": "ops", "from": "Ada", "text": "no reaction yet" }
  ]
}
```

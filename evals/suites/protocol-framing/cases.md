...
```json
{
  ...
  "channels": [
    { "name": "general", "members": ["Lead", "Worker"] }
  ],
  "messages": [
    { "id": "proto_parent", "channel": "general", "from": "Lead", "text": "Parent" }
  ]
}
```
...
```json
[
  { "op": "reply_to_thread", "as": "Worker", "parent": "proto_parent", "text": "Reply frame", "id": "proto_reply" },

...
echo "All files present"`,
    ...
    .step('review-and-commit', {
      ...
      task: `Review the Swift SDK build result and commit the finished package.
...
2. **If the build succeeded:** verify the public API is complete and usable.
...
4. **Commit** all files:
   ...
   SPM package targeting macOS 13+ / iOS 16+.
   - RelayTransport: URLSessionWebSocketTask with exponential-backoff reconnect
   - RelayTypes: Codable structs/enums for full broker wire protocol
   - RelayCast: public entry point — channel pub/sub, agent registration, DMs
   No third-party dependencies."
   \`\`\`

5. After committing, output a summary of what was built.`,
    })

...
- `agent-relay node status` now distinguishes a locally running broker whose name is not Cloud-addressable, and `attach --node` errors point to the SSH/state-directory fallback.

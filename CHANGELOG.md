...
- `agent-relay node agent attach --node` now tolerates 30-second control-plane responses and retries transient reachability failures with 31 seconds of backoff inside a 90-second overall budget.

...
- Native harness sidecars now receive their broker-minted Relay identity and token, allowing their Agent Relay tools to send messages as the spawned agent.

...
- The broker now observes shutdown signals while an event handler is in flight, so a slow Relaycast registration cannot exhaust `node down`'s graceful-shutdown window.

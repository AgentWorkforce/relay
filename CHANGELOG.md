...
- `agent-relay-broker` applies eval-derived relay worker guidance for small models, Gemini, and Droid spawns, and flags Droid as high-risk for delegation roles that need to spawn relay workers.

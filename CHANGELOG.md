...
- Opting out of telemetry (`AGENT_RELAY_TELEMETRY_DISABLED` or `DO_NOT_TRACK`) now also keeps your cloud identity out of child process environments. The identity env vars — one of which carries your email — were published to every spawned process, including third-party harness CLIs, even when opted out.

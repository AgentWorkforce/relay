...
- `@agent-relay/harness-driver` adds local fleet sidecar protocol frames for node and handler registration, broker handler invocation, handler results, and sidecar supervision metadata.

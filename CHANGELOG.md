...
- `agent-relay node agent spawn` and `new` accept `--reasoning <level>` for Codex, Claude, and Grok PTY sessions, rejecting unsupported levels, harnesses, and runtimes.

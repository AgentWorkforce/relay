...
- `release` of a broker-owned worker now cleans up the worker identity even when the host is offline, repeated releases stay idempotent, and the response reports whether the process and identity were stopped and deleted or retained.

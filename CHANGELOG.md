...
- `@agent-relay/harness-driver` adds local fleet sidecar protocol frames for node and handler registration, broker handler invocation, handler results, handler-attributed spawns, and sidecar supervision metadata.

...
- `@agent-relay/openclaw` remains available as an optional OpenClaw adapter package, with managed spawn internals moved to `@agent-relay/driver` instead of the core SDK.

...
- `tests/relayflows/cleanroom/fleet-daytona.matrix.json` (105 operations);
...
- require exactly 153 unique, schema-validated coverage rows: 12 state-machine
  transitions, 23 injected faults, 13 acceptance gates, and all 105 Fleet

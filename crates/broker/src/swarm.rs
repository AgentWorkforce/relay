...
fn build_stage_task(
    ...
    body.push_str(
        "\n\nWhen you are done, use the `mcp__relaycast__remove_agent` MCP tool to release yourself, \
...
async fn wait_for_worker_results(
    ...
    while !pending.is_empty() {
        ...
        match kind {
            ...
            //   - agent_released: agent released itself via mcp__relaycast__remove_agent MCP tool

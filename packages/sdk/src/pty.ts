...
const ANSI_RE =
  /\x1b(?:\[[0-9;?]*[A-Za-z]|\][^\x07\x1b]*(?:\x07|\x1b\\)?|[()][0-9A-Za-z]|[\x20-\x2f]*[\x40-\x7e])|\x1b/g;
...
export function stripAnsi(s: string): string {
  let result = s.replace(CURSOR_FORWARD_CSI_RE, (_match, count: string) => cursorForwardSpaces(count));

...
export function generateSoulMd(
  ...
  return [
    ...
    '',
    '- **Direct reply**: mcp__relaycast__dm__send or relaycast.dm.send (to: "<sender_name>")',
    '- **Channel message**: mcp__relaycast__message__post or relaycast.message.post (channel: "<channel>")',
    '- **Thread reply**: mcp__relaycast__message__reply or relaycast.message.reply',
    '- **Check inbox**: mcp__relaycast__inbox__check or relaycast.inbox.check',
    '',
    'You are pre-registered by the broker under your assigned worker name.',
    'Do not call mcp__relaycast__agent__register unless a send/reply fails with "Not registered".',

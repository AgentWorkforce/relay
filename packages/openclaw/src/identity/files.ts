...
export function generateSoulMd(
  ...
  return [
    ...
    '',
    '- **Direct reply**: mcp__relaycast__message_dm_send or relaycast.message.dm.send (to: "<sender_name>")',
    ...
    '- **Check inbox**: mcp__relaycast__message_inbox_check or relaycast.message.inbox.check',
    '',

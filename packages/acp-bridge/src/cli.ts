 ...
 *   --socket <path>   Deprecated broker socket path
 *   --debug           Enable debug logging
 *
 * Environment:
 *   ANTHROPIC_API_KEY  Not required (we use relay agents, not Claude API directly)
 *   AGENT_RELAY_API_KEY or RELAY_API_KEY
 *   AGENT_RELAY_BASE_URL or RELAY_BASE_URL
 */
...
NOTES:
  - Uses the public Agent Relay SDK messaging API
  - Communicates with editors via stdin/stdout (ACP protocol)
  - Managed spawn/release commands require driver actions to be registered by the host

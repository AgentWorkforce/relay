 ...
 *
 * This file documents the data formats used in the agent-relay message flow:
 *
 * 1. Agent → File (outbox)     : RelayFileFormat
 * 2. agent-relay → Orchestrator  : ParsedRelayCommand (JSON on stderr)
...
// =============================================================================
// STEP 2: agent-relay emits JSON to stderr (captured by orchestrator)
// =============================================================================

/**
 * JSON format emitted by agent-relay to stderr when it detects a relay command.
...
/**
 * JSON format emitted by agent-relay to stderr for continuity commands.
 *
...
// =============================================================================
// STEP 3: Orchestrator sends to agent-relay socket for injection
// =============================================================================

/**
 * JSON format sent to the agent-relay Unix socket for message injection.
 * Socket path: /tmp/agent-relay-{agentName}.sock
 *
 * @example
 * ```json
 * {
...
/**
 * Response from agent-relay socket
 */
 ...
 * │                              │                                               │
 * │                              ▼                                               │
 * │  STEP 3: agent-relay reads file, emits JSON to stderr                          │
 * │  ┌──────────────────────────────────────────────────────────────────────┐   │
 ...
 * │                              │                                               │
 * │                              ▼                                               │
 * │  STEP 4: Orchestrator routes to Bob's agent-relay socket                       │
 * │  ┌──────────────────────────────────────────────────────────────────────┐   │
 ...
 * │                              │                                               │
 * │                              ▼                                               │
 * │  STEP 5: Bob's agent-relay injects plain text into PTY                         │
 * │  ┌──────────────────────────────────────────────────────────────────────┐   │
 * │  │ Relay message from Alice [abc1234]: Hello Bob, can you review PR #42?│   │
 * │  └──────────────────────────────────────────────────────────────────────┘   │
 * │                                                                              │

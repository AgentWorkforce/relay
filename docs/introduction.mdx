...
<CardGroup cols={3}>
  ...
  <Card title="Sub-5ms Local Routing" icon="bolt">
    Messages route locally for near-instant agent-to-agent communication.
  </Card>
...
**Daemon** - Central message broker that routes messages between agents.

**Wrapper** - Wraps each agent CLI in a PTY session, parses output for relay commands, and injects incoming messages.

...
Agent Relay provides real-time messaging between AI agents using a file-based protocol. Messages are delivered instantly through the relay daemon, enabling seamless coordination between agents.
...
<AccordionGroup>
  ...
  <Accordion title="Agent not receiving messages">
    ...
    3. Verify the daemon is running: `agent-relay status`
  </Accordion>

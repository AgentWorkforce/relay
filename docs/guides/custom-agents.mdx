...
<Step title="Define frontmatter">
  ```yaml --- name: security-auditor description: Security-focused code review and vulnerability assessment
  model: sonnet tools: Read, Grep, Glob, Bash skills: using-agent-relay --- ```
</Step>
...
```
relay_spawn(name: "Reviewer", cli: "claude --agent reviewer", task: "Please review the changes in src/auth/:\n- Focus on security implications\n- Check error handling\n- Verify test coverage")
```

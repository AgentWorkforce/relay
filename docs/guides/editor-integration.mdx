...
Currently supported commands: spawn, release, agents/who. All other messages are still broadcast to your connected agents. A quick help block is shown when a new conversation starts; type `agent-relay help` to see it again.

...
**Code: Broker Agent Spawn** (`src/main.rs`)

```typescript
// SDK drives the broker via stdio protocol
...
relay_send(to: "North", message: "Your turn. Play a card.")
// With await syntax for synchronous messaging:

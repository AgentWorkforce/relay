...
<Note>
The skill is included in the `@agent-relay/openclaw` package at `skill/SKILL.md`. See the [full skill reference](https://github.com/AgentWorkforce/relay/blob/main/packages/openclaw/skill/SKILL.md) for all commands and examples.
</Note>

...
description: 'Start, inspect, and stop the optional local broker runtime used for managed CLI agents.'
---

The version 8 core product is workspace messaging. The local broker is optional: use it when this machine should run managed CLI agents or attach to PTY/headless sessions.

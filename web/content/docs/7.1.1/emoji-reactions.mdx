...
Reactions are part of the Agent Relay messaging surface. They are exposed in relay-aware clients such as the Claude Code plugin and Agent Relay MCP tools.

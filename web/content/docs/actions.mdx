...
For README-style app callbacks, use the facade API on [Actions and callbacks](/docs/8.0.0/actions-callbacks). This page describes the lower-level action model that both the facade and MCP tool generation use.
...
The action implementation can live in your SDK process, a harness driver package, a server, or an adapter.

...
The local runtime is optional. It manages a broker process, dashboard, PTY/headless agents, attach modes, logs, and release for CLI agents running on this machine.
...
<CardGroup cols={2}>
  ...
  <Card title="Actions and callbacks" href="/docs/8.0.0/actions-callbacks">
    Register callbacks that agents can invoke as structured actions.
  </Card>
</CardGroup>

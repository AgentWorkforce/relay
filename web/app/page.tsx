        ...
        <section className={s.hero}>
          <div className={s.heroLeft}>
            ...
            <p className={s.subtitle}>
              The best way to build agents that communicate, coordinate, and take action. Spawn agents from
              code and organize them with channels, messages, and reactions.
            </p>
        ...
        <section className={s.featuresSection}>
          <FadeIn direction="up" delay={0} className={s.featureCol}>
            <div className={s.featurePreview}>
              ...
              <div className={s.previewTerminal}>
                ...
                <pre className={s.previewCode}>
                  ...
                  {'\n'}
                  <span className={s.codeKeyword}>import</span>
                  {' { '}
                  <span className={s.codeType}>AgentRelay</span>
                  {' } '}
                  <span className={s.codeKeyword}>from</span>{' '}
                  <span className={s.codeString}>{'"@agent-relay/sdk"'}</span>
                  {';\n\n'}
                  <span className={s.codeKeyword}>const</span>
                  {' relay = '}
                  <span className={s.codeKeyword}>new</span> <span className={s.codeType}>AgentRelay</span>
                  {'();\n\n'}
                  <span className={s.codeKeyword}>await</span>
                  {' relay.claude.'}
                  <span className={s.codeMethod}>spawn</span>
                  {'({\n'}
                  {'  name: '}
                  <span className={s.codeString}>{'"Planner"'}</span>
                  {',\n'}
                  {'  task: '}
                  <span className={s.codeString}>{'"Design the architecture"'}</span>
                  {',\n'}
                  {'}); \n\n'}
                  <span className={s.codeKeyword}>await</span>
                  {' relay.codex.'}
                  ...
                  {'({\n'}
                  {'  name: '}
                  <span className={s.codeString}>{'"Builder"'}</span>
                  {',\n'}
                  {'  task: '}
                  <span className={s.codeString}>{'"Implement the plan"'}</span>
                  {',\n'}
                  {'}); \n\n'}
            ...
            <p className={s.featureDesc}>
              Launch Claude, Codex, Gemini, or OpenCode agents with a few lines. Mix models in a single
              workflow.
            </p>
          </FadeIn>
          ...
          <FadeIn direction="up" delay={240} className={s.featureCol}>
            ...
            <p className={s.featureDesc}>
              See every agent&apos;s status, messages, and channels in real time. Full observability out of
              the box.
            </p>
          </FadeIn>
        </section>

...
import { SdkCodeExample } from '../components/SdkCodeExample';
    ...
    <div className={s.page}>
      ...
      <div className={s.sdkWrapper}>
        <section className={s.sdkSection}>
          <FadeIn direction="right" delay={0} className={s.sdkCode}>
            <SdkCodeExample />
          </FadeIn>
          <FadeIn direction="left" delay={150} className={s.sdkText}>
            <h2 className={s.sdkTitle}>The Agent Relay SDK</h2>
            <p className={s.sdkSubtitle}>
              Add the rails to keep your agents together with a simple import and
              a few lines of code.
            </p>
            <Link href="/docs/quickstart" className={s.sdkLink}>
              Read the quickstart

...
function GeminiLogo() {
  return (
    <svg className={s.providerLogo} viewBox="0 0 24 24" aria-hidden="true">
      ...
      />
      <defs>
        <linearGradient gradientUnits="userSpaceOnUse" id="mraf0" x1="7" x2="11" y1="15.5" y2="12">
          <stop stopColor="#08B962" />
          <stop offset="1" stopColor="#08B962" stopOpacity="0" />
        </linearGradient>
        <linearGradient gradientUnits="userSpaceOnUse" id="mraf1" x1="8" x2="11.5" y1="5.5" y2="11">
          <stop stopColor="#F94543" />
          <stop offset="1" stopColor="#F94543" stopOpacity="0" />
        </linearGradient>
        <linearGradient gradientUnits="userSpaceOnUse" id="mraf2" x1="3.5" x2="17.5" y1="13.5" y2="12">
